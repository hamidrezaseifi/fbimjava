...
public class IfcStairRender {
  ...
  public List<IfcStairFlightRender> getStairFlightList() {
    return stairFlightList;
  }

  public void setStairFlightList(final List<IfcStairFlightRender> stairFlightList) {
    this.stairFlightList = stairFlightList;
  }

  public List<IfcStairMemberRender> getMemberList() {
    return memberList;
  }

  public void setMemberList(final List<IfcStairMemberRender> memberList) {
    this.memberList = memberList;
  }

  public List<IfcStairRailingRender> getRailingList() {
    return railingList;
  }

  public void setRailingList(final List<IfcStairRailingRender> railingList) {
