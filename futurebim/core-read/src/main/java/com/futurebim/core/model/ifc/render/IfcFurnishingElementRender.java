...
public class IfcFurnishingElementRender {
  ...
  @JacksonXmlElementWrapper(useWrapping = false)
  private List<IfcFurnitureTypeSetRender> furnitureTypeList;
  ...
  public List<IfcOpeningElementRender> getOpeningElementList() {
    return openingElementList;
  }

  public void setOpeningElementList(final List<IfcOpeningElementRender> openingElementList) {
    this.openingElementList = openingElementList;
  }

  public List<IfcFurnitureTypeSetRender> getFurnitureTypeList() {
    return furnitureTypeList;
  }

  public void setFurnitureTypeList(final List<IfcFurnitureTypeSetRender> furnitureTypeList) {
