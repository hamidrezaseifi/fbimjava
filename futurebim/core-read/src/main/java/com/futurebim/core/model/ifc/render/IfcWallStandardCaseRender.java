...
public class IfcWallStandardCaseRender {
  ...
  public List<IfcOpeningElementRender> getPpeningElementList() {
    return openingElementList;
  }

  public void setPpeningElementList(final List<IfcOpeningElementRender> ppeningElementList) {
    this.openingElementList = ppeningElementList;
  }
