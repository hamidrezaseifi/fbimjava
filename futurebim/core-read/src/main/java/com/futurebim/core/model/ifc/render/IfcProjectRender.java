...
public class IfcProjectRender {
  ...
  private List<IfcProjectSiteRender> sites = new ArrayList<>();
  ...
  public List<IfcProjectSiteRender> getSites() {
    return sites;
  }

  public void setSites(final List<IfcProjectSiteRender> sites) {
    this.sites = sites;
  }
