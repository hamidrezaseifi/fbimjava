...
public class IfcWindowRender {
  ...
  public List<IfcWindowStyleSet> getEindowStyleSetList() {
    return windowStyleSetList;
  }

  public void setEindowStyleSetList(final List<IfcWindowStyleSet> eindowStyleSetList) {
    this.windowStyleSetList = eindowStyleSetList;
  }
