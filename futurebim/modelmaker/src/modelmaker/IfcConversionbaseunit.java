...
/**
 * The persistent class for the ifc_conversionbaseunits database table.
 * 
 */
@Entity
@Table(name="ifc_conversionbaseunits")
@NamedQuery(name="IfcConversionbaseunit.findAll", query="SELECT i FROM IfcConversionbaseunit i")
public class IfcConversionbaseunit implements Serializable {
