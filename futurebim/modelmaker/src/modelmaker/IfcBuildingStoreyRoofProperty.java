...
@NamedQuery(name="IfcBuildingStoreyRoofProperty.findAll", query="SELECT i FROM IfcBuildingStoreyRoofProperty i")
public class IfcBuildingStoreyRoofProperty implements Serializable {
