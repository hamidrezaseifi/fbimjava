...
public class GuiIfcDoor {
  ...
  private final String type = "IfcDoor";
  
  public GuiIfcDoor(final IfcDoorEdo edo){
    setId(edo.getId());
    setName(edo.getName());
    ...
    for(final IfcDoorStyleSetEdo item: edo.getDoorStyleList()){
      addDoorStyle(new GuiIfcDoorStyleSet(item));
    }
