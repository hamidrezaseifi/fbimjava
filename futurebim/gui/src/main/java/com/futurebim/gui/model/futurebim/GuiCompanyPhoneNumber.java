...
import com.futurebim.common.model.edo.CompanyPhoneNumberEdo;

/**
 * The persistent class for the companies database table.
 *
 */
public class GuiCompanyPhoneNumber {
  ...
  public static GuiCompanyPhoneNumber fromEdo(final CompanyPhoneNumberEdo edo) {
    final GuiCompanyPhoneNumber number = new GuiCompanyPhoneNumber();
  ...
  public static List<GuiCompanyPhoneNumber> fromEdoList(final List<CompanyPhoneNumberEdo> edoList) {
    
    final List<GuiCompanyPhoneNumber> list = new ArrayList<>();
    for (final CompanyPhoneNumberEdo edo : edoList) {
      list.add(GuiCompanyPhoneNumber.fromEdo(edo));
    }
    return list;
  }
  
  public static List<CompanyPhoneNumberEdo> toEdoList(final List<GuiCompanyPhoneNumber> list) {
    
    final List<CompanyPhoneNumberEdo> edoList = new ArrayList<>();
    for (final GuiCompanyPhoneNumber p : list) {
      edoList.add(p.toEdo());
    }
    return edoList;
  }
