 ...
 *
 */
public class GuiTask extends DateLimitedBase {
  ...
  private final List<GuiSubTask> subTasks = new ArrayList<>();
  ...
  public float getProgress() {
    ...
    if (subTasks.size() > 0) {
      for (final GuiSubTask stask : subTasks) {
        prog += stask.getProgress();
      }
   ...
   * @return the subTasks
   */
  public List<GuiSubTask> getSubTasks() {
    return subTasks;
  }
   ...
   */
  public void setSubTasks(final List<GuiSubTask> subTasks) {
    this.subTasks.clear();
    if (subTasks != null) {
   ...
   */
  public GuiTask setEditable(final boolean isEditable) {
  ...
  public TaskEdo toEdo() {
    ...
    edo.setSubTasks(GuiSubTask.toEdoList(subTasks));
  ...
  public static GuiTask fromEdo(final TaskEdo edo) {
    ...
    model.setSubTasks(GuiSubTask.fromEdoList(edo.getSubTasks()));
