...
public class GuiIfcFurnishingElement {
  ...
  private final String type = "IfcFurnishingElement";

  public GuiIfcFurnishingElement(final IfcFurnishingElementEdo edo){
    setId(edo.getId());
    setName(edo.getName());
    ...
    for(final IfcFurnitureTypeSetEdo item: edo.getFurnitureTypeList()){
      addFurnitureType(new GuiIfcFurnitureTypeSet(item));
    }
  ...
  public List<Object> getChildren() {
    ...
    children.addAll(furnitureTypeList);
