...
public class WorkflowController extends UiControllerBase {
  ...
  public GuiWorkflowCheckResult checkForChangeInWorkflows(@PathVariable(name = "workflowid") final long workflowid, @RequestBody final GuiWorkflowCheck checkList) {
