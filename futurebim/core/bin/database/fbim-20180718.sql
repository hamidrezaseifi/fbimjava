...
CREATE TABLE `ifc_building_storey_covering` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYCOVERING_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_footing` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFOOTING_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOF_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENING_ROOF` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_opening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_opening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLAB_STOREY` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_slab_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENING_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_slab_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_slab_opening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_slab_opening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABPRESENTATION_OPENING` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABPROPERTIES_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENING_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_slab_opening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_slab_opening` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRPRESENTATION_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_project_site` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  `updated` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  `ifc_project_sitecol` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-07-18 16:03:28
