...
CREATE TABLE `ifc_building_properties` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGPROPERTIES_BUILDING_idx` (`building_id`),
  CONSTRAINT `IFCBUILDINGPROPERTIES_BUILDING` FOREIGN KEY (`building_id`) REFERENCES `ifc_building` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey` (
  ...
  `guid` varchar(50) NOT NULL,
  `building_id` int(11) NOT NULL,
  `storey_name` varchar(150) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `composition_type` varchar(50) NOT NULL,
...
CREATE TABLE `ifc_building_storey_beam` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYBEAM_STOREY_idx` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYBEAM_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_beam_presentationlayers` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYBEAMPLAYER_BEAM_idx` (`beam_id`),
...
CREATE TABLE `ifc_building_storey_beam_properties` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYBEAM_BEAM_idx` (`beam_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4537 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_covering` (
  ...
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `covering_name` varchar(150) NOT NULL,
  `object_type` varchar(50) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `tag` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYCOVERING_STOREY_idx` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYCOVERING_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_covering_presentationlayers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `covering_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYCOVERINGPLAYER_COVERING_idx` (`covering_id`),
  CONSTRAINT `IFCBUILDINGSTOREYCOVERINGPLAYER_COVERING` FOREIGN KEY (`covering_id`) REFERENCES `ifc_building_storey_covering` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_covering_properties` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYCOVERING_COVERING_idx` (`covering_id`),
  CONSTRAINT `IFCBUILDINGSTOREYCOVERING_COVERING` FOREIGN KEY (`covering_id`) REFERENCES `ifc_building_storey_covering` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_door` (
  ...
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `door_name` varchar(150) NOT NULL,
  `object_type` varchar(50) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `tag` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYDOOR_STOREY_idx` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYDOOR_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_door_presentationlayer` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYDOORPRESENTATION_DOOR` (`door_id`),
  CONSTRAINT `IFCBUILDINGSTOREYDOORPRESENTATION_DOOR` FOREIGN KEY (`door_id`) REFERENCES `ifc_building_storey_door` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_door_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORPROPERTIES_DOOR` FOREIGN KEY (`door_id`) REFERENCES `ifc_building_storey_door` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_door_style` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORSTYLE_DOOR` FOREIGN KEY (`door_id`) REFERENCES `ifc_building_storey_door` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ifc_building_storey_footing`
--

DROP TABLE IF EXISTS `ifc_building_storey_footing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_footing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `footing_name` varchar(150) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYFOOTING_STOREY` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFOOTING_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_footing`
--

LOCK TABLES `ifc_building_storey_footing` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_footing` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_footing` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_footing_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_footing_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_footing_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `footing_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFOOTINGPRESENTATION_FOOTING` (`footing_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFOOTINGPRESENTATION_FOOTING` FOREIGN KEY (`footing_id`) REFERENCES `ifc_building_storey_footing` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_footing_presentationlayer`
--

LOCK TABLES `ifc_building_storey_footing_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_footing_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_footing_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_footing_properties`
--

DROP TABLE IF EXISTS `ifc_building_storey_footing_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_footing_properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `footing_id` int(11) NOT NULL,
  `property_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFOOTINGPROPERTIES_FOOTING` FOREIGN KEY (`footing_id`) REFERENCES `ifc_building_storey_footing` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2927 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_footing_properties`
--

LOCK TABLES `ifc_building_storey_footing_properties` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_footing_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_footing_properties` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ifc_building_storey_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYPROPERTIES_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
--
-- Table structure for table `ifc_building_storey_roof`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `roof_name` varchar(150) NOT NULL,
  `object_type` varchar(100) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYROOF_STOREY` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOF_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof`
--

LOCK TABLES `ifc_building_storey_roof` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_opening`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_opening`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_opening` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYROOFOPENING_ROOF` (`roof_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENING_ROOF` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_opening`
--

LOCK TABLES `ifc_building_storey_roof_opening` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_opening` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_opening` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_opening_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_opening_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_opening_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYROOFOPENINGPRESENTATION_OPENING` (`opening_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_opening_presentationlayer`
--

LOCK TABLES `ifc_building_storey_roof_opening_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_opening_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_opening_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_opening_properties`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_opening_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_opening_properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opening_id` int(11) NOT NULL,
  `property_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYROOFOPENINGPROPERTIES_OPENING` (`opening_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_opening_properties`
--

LOCK TABLES `ifc_building_storey_roof_opening_properties` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_opening_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_opening_properties` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `roof_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFPRESENTATION_FOOTING` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_presentationlayer`
--

LOCK TABLES `ifc_building_storey_roof_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_properties`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `roof_id` int(11) NOT NULL,
  `property_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFPROPERTIES_FOOTING` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_properties`
--

LOCK TABLES `ifc_building_storey_roof_properties` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_properties` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_slab`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_slab`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_slab` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  `roof_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYROOFSLAB_STOREY` (`roof_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLAB_STOREY` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_slab`
--

LOCK TABLES `ifc_building_storey_roof_slab` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_slab_opening`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_slab_opening`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_slab_opening` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYROOFSLABOPENING_SLAB` (`slab_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENING_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_slab_opening`
--

LOCK TABLES `ifc_building_storey_roof_slab_opening` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_opening` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_opening` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_slab_opening_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_slab_opening_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_slab_opening_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opening_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYROOFSLABOPENINGPRESENTATION_OPENING` (`opening_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_slab_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_slab_opening_presentationlayer`
--

LOCK TABLES `ifc_building_storey_roof_slab_opening_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_opening_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_opening_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_slab_opening_properties`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_slab_opening_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_slab_opening_properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opening_id` int(11) NOT NULL,
  `property_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYROOFSLABOPENINGPROPERTIES_OPENING` (`opening_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_slab_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_slab_opening_properties`
--

LOCK TABLES `ifc_building_storey_roof_slab_opening_properties` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_opening_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_opening_properties` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_slab_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_slab_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_slab_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `slab_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYROOFSLABPRESENTATION_OPENING` (`slab_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABPRESENTATION_OPENING` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_slab_presentationlayer`
--

LOCK TABLES `ifc_building_storey_roof_slab_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_roof_slab_properties`
--

DROP TABLE IF EXISTS `ifc_building_storey_roof_slab_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_roof_slab_properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `slab_id` int(11) NOT NULL,
  `property_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYROOFSLABPROPERTIES_SLAB` (`slab_id`),
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABPROPERTIES_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_roof_slab_properties`
--

LOCK TABLES `ifc_building_storey_roof_slab_properties` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_roof_slab_properties` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ifc_building_storey_slab` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLAB_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ifc_building_storey_slab_opening`
--

DROP TABLE IF EXISTS `ifc_building_storey_slab_opening`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_slab_opening` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  `slab_id` int(11) NOT NULL,
  `opening_name` varchar(150) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYSLABOPENING_SLAB` (`slab_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENING_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_slab_opening`
--

LOCK TABLES `ifc_building_storey_slab_opening` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_slab_opening` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_slab_opening` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_slab_opening_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_slab_opening_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_slab_opening_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opening_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSLABOPENINGPRESENTATION_OPENING` (`opening_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_slab_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_slab_opening_presentationlayer`
--

LOCK TABLES `ifc_building_storey_slab_opening_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_slab_opening_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_slab_opening_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ifc_building_storey_slab_opening_properties`
--

DROP TABLE IF EXISTS `ifc_building_storey_slab_opening_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_slab_opening_properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opening_id` int(11) NOT NULL,
  `property_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSLABOPENINGPROPERTIES_OPENING` (`opening_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_slab_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_slab_opening_properties`
--

LOCK TABLES `ifc_building_storey_slab_opening_properties` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_slab_opening_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_slab_opening_properties` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ifc_building_storey_slab_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABPRESENTATION_OPENING` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_slab_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABPROPERTIES_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4657 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACE_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_felement_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_space_furnishingelement_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=389 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENT_STOREY` (`space_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENT_STOREY` FOREIGN KEY (`space_id`) REFERENCES `ifc_building_storey_space` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_furnituretypes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `felement_id` int(11) NOT NULL,
  `furnituretype_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENTFURNITURETYPES_FELEMENT` (`felement_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTFURNITURETYPES_FELEMENT` FOREIGN KEY (`felement_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_opening` (
  ...
  `open_name` varchar(150) NOT NULL,
  `object_type` varchar(50) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `tag` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEOPENING_SPACE` FOREIGN KEY (`element_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_space_furnishingelement_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3189 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENTPLAYER_FELEMENT` (`felement_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTPLAYER_FELEMENT` FOREIGN KEY (`felement_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2483 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENT_FELEMENT` (`felement_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENT_FELEMENT` FOREIGN KEY (`felement_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=19553 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_presentationlayers` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSPACEPRESENTATION_STAIR` (`space_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSPACEPRESENTATION_STAIR` FOREIGN KEY (`space_id`) REFERENCES `ifc_building_storey_space` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_space_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACE_SPACE` FOREIGN KEY (`space_id`) REFERENCES `ifc_building_storey_space` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4945 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair` (
  ...
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `stair_name` varchar(150) NOT NULL,
  `object_type` varchar(50) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `tag` varchar(50) NOT NULL,
  `shape_type` varchar(50) NOT NULL,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIR_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight` (
  ...
  `treads_length` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `version` int(11) NOT NULL,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  `updated` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHT_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHTPLAYER_FLIGHT` FOREIGN KEY (`flight_id`) REFERENCES `ifc_building_storey_stair_flight` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHTPROPERTIES_FLIGHT` FOREIGN KEY (`flight_id`) REFERENCES `ifc_building_storey_stair_flight` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_member` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBER_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_member_presentationlayers` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRMEMBERPLAYER_MEMBER` (`member_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBERPLAYER_MEMBER` FOREIGN KEY (`member_id`) REFERENCES `ifc_building_storey_stair_member` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_stair_member_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBER_MEMBER` FOREIGN KEY (`member_id`) REFERENCES `ifc_building_storey_stair_member` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ifc_building_storey_stair_presentationlayer`
--

DROP TABLE IF EXISTS `ifc_building_storey_stair_presentationlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ifc_building_storey_stair_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stair_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRPRESENTATION_STAIR` (`stair_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRPRESENTATION_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ifc_building_storey_stair_presentationlayer`
--

LOCK TABLES `ifc_building_storey_stair_presentationlayer` WRITE;
/*!40000 ALTER TABLE `ifc_building_storey_stair_presentationlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifc_building_storey_stair_presentationlayer` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ifc_building_storey_stair_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRPROPERTIES_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_stair_railing` (
  ...
  `guid` varchar(50) NOT NULL,
  `stair_id` int(11) NOT NULL,
  `railing_name` varchar(150) NOT NULL,
  `object_type` varchar(50) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `predefined_type` varchar(45) NOT NULL,
  `tag` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `version` int(11) NOT NULL,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILING_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_railing_presentationlayers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `railing_id` int(11) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRRAILINGPLAYER_RAILING` (`railing_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILINGPLAYER_RAILING` FOREIGN KEY (`railing_id`) REFERENCES `ifc_building_storey_stair_railing` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_stair_railing_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILING_RAILING` FOREIGN KEY (`railing_id`) REFERENCES `ifc_building_storey_stair_railing` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_wall` (
  ...
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `wall_name` varchar(120) NOT NULL,
  `object_type` varchar(100) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `tag` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALL_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENING_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wall` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wall_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wall_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLPRESENTATION_OPENING` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wall` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_wall_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLPROPERTIES_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wall` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_wallstandardcase` (
  ...
  `guid` varchar(50) NOT NULL,
  `storey_id` int(11) NOT NULL,
  `wall_name` varchar(150) NOT NULL,
  `object_type` varchar(50) NOT NULL,
  `object_placement` varchar(50) NOT NULL,
  `tag` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASE_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEOPENING_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wallstandardcase` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wallstandardcase_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wallstandardcase_opening` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEPRESENTATION_OPENING` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wallstandardcase` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_wallstandardcase_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEPROPERTIES_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wallstandardcase` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_window` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOW_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_window_presentationlayer` (
  ...
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYWINDOWPRESENTATION_WINDOW` (`window_id`),
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWPRESENTATION_WINDOW` FOREIGN KEY (`window_id`) REFERENCES `ifc_building_storey_window` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_window_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWPROPERTIES_WINDOW` FOREIGN KEY (`window_id`) REFERENCES `ifc_building_storey_window` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ifc_building_storey_window_style` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWSTYLE_WINDOW` FOREIGN KEY (`window_id`) REFERENCES `ifc_building_storey_window` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_project` (
  ...
  `project_long_name` varchar(300) NOT NULL,
...
CREATE TABLE `ifc_project_site` (
  ...
  `object_placement` varchar(50) NOT NULL,
  `composition_type` varchar(50) NOT NULL,
  `ref_latitude` varchar(45) NOT NULL,
  `ref_longitude` varchar(45) NOT NULL,
  `ref_elevation` varchar(45) NOT NULL,
  `tag` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `version` int(11) NOT NULL,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
...
) ENGINE=InnoDB AUTO_INCREMENT=152905 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_windowstyle` (
  ...
  `operation_type` varchar(50) NOT NULL,
  `construction_type` varchar(50) NOT NULL,
  `parameter_takes_precedence` varchar(150) NOT NULL,
  `sizeable` varchar(10) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `version` int(11) NOT NULL,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
...
-- Dump completed on 2018-07-19 12:59:58
