...
public class SubTask {
  ...
  public static SubTask fromEdo(final SubTaskEdo edo) {
  ...
  public static List<SubTaskEdo> toEdoList(final List<SubTask> list) {
    
    final List<SubTaskEdo> edoList = new ArrayList<>();
    for (final SubTask p : list) {
      edoList.add(p.toEdo());
    }
    return edoList;
  }
  
  public static List<SubTask> fromEdoList(final List<SubTaskEdo> edoList) {
    
    final List<SubTask> list = new ArrayList<>();
    for (final SubTaskEdo edo : edoList) {
      list.add(SubTask.fromEdo(edo));
    }
    return list;
  }
}
