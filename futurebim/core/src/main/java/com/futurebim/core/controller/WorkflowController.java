...
public class WorkflowController {
  ...
  public CheckVersionEdo checkWorkflowVersion(@RequestBody(required = true) final CheckVersionEdo checkingWorkflow) throws StorageException {
    return workflowHandler.checkWorkflowVersion(CheckVersion.fromEdo(checkingWorkflow)).toEdo();
  }
