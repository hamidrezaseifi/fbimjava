...
import com.futurebim.core.model.UserDeleteRequestResult;
...
public interface IUserHandler {
	...
	public UserDeleteRequestResult getUserDeleteRequestResult(final Long userId) throws StorageException;
