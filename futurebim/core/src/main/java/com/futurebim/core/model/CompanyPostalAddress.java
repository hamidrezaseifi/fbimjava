...
import com.futurebim.common.model.edo.CompanyPostalAddressEdo;

/**
 * The persistent class for the companies database table.
 *
 */
public class CompanyPostalAddress {
  ...
  public static CompanyPostalAddress fromEdo(final CompanyPostalAddressEdo edo) {
  ...
  public static List<CompanyPostalAddressEdo> toEdoList(final List<CompanyPostalAddress> list) {
    
    final List<CompanyPostalAddressEdo> edoList = new ArrayList<>();
    for (final CompanyPostalAddress p : list) {
      edoList.add(p.toEdo());
    }
    return edoList;
  }
  
  public static List<CompanyPostalAddress> fromEdoList(final List<CompanyPostalAddressEdo> edoList) {
    
    final List<CompanyPostalAddress> list = new ArrayList<>();
    for (final CompanyPostalAddressEdo edo : edoList) {
      list.add(CompanyPostalAddress.fromEdo(edo));
    }
    return list;
  }
}
