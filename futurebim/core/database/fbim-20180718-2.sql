...
CREATE TABLE `ifc_building_storey_beam` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYBEAM_STOREY` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYBEAM_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_beam_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYBEAMPLAYER_BEAM` FOREIGN KEY (`beam_id`) REFERENCES `ifc_building_storey_beam` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_beam_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYBEAM_BEAM` (`beam_id`),
  CONSTRAINT `IFCBUILDINGSTOREYBEAM_BEAM` FOREIGN KEY (`beam_id`) REFERENCES `ifc_building_storey_beam` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_covering` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `guid_UNIQUE` (`guid`),
  KEY `IFCBUILDINGSTOREYCOVERING_STOREY` (`storey_id`),
  CONSTRAINT `IFCBUILDINGSTOREYCOVERING_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_covering_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYCOVERINGPLAYER_COVERING` FOREIGN KEY (`covering_id`) REFERENCES `ifc_building_storey_covering` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_covering_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYCOVERING_COVERING` (`covering_id`),
  CONSTRAINT `IFCBUILDINGSTOREYCOVERING_COVERING` FOREIGN KEY (`covering_id`) REFERENCES `ifc_building_storey_covering` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_door` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOOR_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_door_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORPRESENTATION_DOOR` FOREIGN KEY (`door_id`) REFERENCES `ifc_building_storey_door` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_door_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORPROPERTIES_DOOR` FOREIGN KEY (`door_id`) REFERENCES `ifc_building_storey_door` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_door_style` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORSTYLE_DOOR` FOREIGN KEY (`door_id`) REFERENCES `ifc_building_storey_door` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_footing` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFOOTING_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_footing_presentationlayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `footing_id` varchar(50) NOT NULL,
  `presentationlayer_id` varchar(50) NOT NULL,
  `status` smallint(6) NOT NULL DEFAULT 1,
  `created` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFOOTINGPRESENTATION_FOOTING` (`footing_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFOOTINGPRESENTATION_FOOTING` FOREIGN KEY (`footing_id`) REFERENCES `ifc_building_storey_footing` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_footing_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFOOTINGPROPERTIES_FOOTING` FOREIGN KEY (`footing_id`) REFERENCES `ifc_building_storey_footing` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYPROPERTIES_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOF_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENING_ROOF` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFPRESENTATION_FOOTING` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFPROPERTIES_FOOTING` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLAB_STOREY` FOREIGN KEY (`roof_id`) REFERENCES `ifc_building_storey_roof` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_slab_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENING_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_roof_slab_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_slab_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_roof_slab_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABPRESENTATION_OPENING` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_roof_slab_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYROOFSLABPROPERTIES_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_roof_slab` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLAB_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENING_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_slab_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_slab_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABPRESENTATION_OPENING` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_slab_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABPROPERTIES_SLAB` FOREIGN KEY (`slab_id`) REFERENCES `ifc_building_storey_slab` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_space` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACE_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_felement_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_space_furnishingelement_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=389 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENT_STOREY` FOREIGN KEY (`space_id`) REFERENCES `ifc_building_storey_space` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_furnituretypes` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTFURNITURETYPES_FELEMENT` FOREIGN KEY (`felement_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEOPENING_SPACE` FOREIGN KEY (`element_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_space_furnishingelement_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTPLAYER_FELEMENT` FOREIGN KEY (`felement_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2483 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENT_FELEMENT` (`felement_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENT_FELEMENT` FOREIGN KEY (`felement_id`) REFERENCES `ifc_building_storey_space_furnishingelement` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_space_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACEPRESENTATION_STAIR` FOREIGN KEY (`space_id`) REFERENCES `ifc_building_storey_space` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_space_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSPACE_SPACE` FOREIGN KEY (`space_id`) REFERENCES `ifc_building_storey_space` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_stair` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guid` varchar(50) NOT NULL,
  `storey_id` varchar(150) NOT NULL,
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIR_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHT_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHTPLAYER_FLIGHT` FOREIGN KEY (`flight_id`) REFERENCES `ifc_building_storey_stair_flight` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHTPROPERTIES_FLIGHT` FOREIGN KEY (`flight_id`) REFERENCES `ifc_building_storey_stair_flight` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_member` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBER_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_member_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBERPLAYER_MEMBER` FOREIGN KEY (`member_id`) REFERENCES `ifc_building_storey_stair_member` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_stair_member_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRMEMBER_MEMBER` (`member_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBER_MEMBER` FOREIGN KEY (`member_id`) REFERENCES `ifc_building_storey_stair_member` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRPRESENTATION_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRPROPERTIES_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_stair_railing` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILING_STAIR` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey_stair` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_railing_presentationlayers` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILINGPLAYER_RAILING` FOREIGN KEY (`railing_id`) REFERENCES `ifc_building_storey_stair_railing` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_stair_railing_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRRAILING_RAILING` (`railing_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILING_RAILING` FOREIGN KEY (`railing_id`) REFERENCES `ifc_building_storey_stair_railing` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_wall` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALL_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENING_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wall` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wall_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wall_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLPRESENTATION_OPENING` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wall` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_wall_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLPROPERTIES_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wall` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_wallstandardcase` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASE_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_opening` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEOPENING_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wallstandardcase` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_opening_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEOPENINGPRESENTATION_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wallstandardcase_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_opening_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEOPENINGPROPERTIES_OPENING` FOREIGN KEY (`opening_id`) REFERENCES `ifc_building_storey_wallstandardcase_opening` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wallstandardcase_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEPRESENTATION_OPENING` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wallstandardcase` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_wallstandardcase_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLSTANDARDCASEPROPERTIES_WALL` FOREIGN KEY (`wall_id`) REFERENCES `ifc_building_storey_wallstandardcase` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_window` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOW_STOREY` FOREIGN KEY (`storey_id`) REFERENCES `ifc_building_storey` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_window_presentationlayer` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWPRESENTATION_WINDOW` FOREIGN KEY (`window_id`) REFERENCES `ifc_building_storey_window` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_window_properties` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWPROPERTIES_WINDOW` FOREIGN KEY (`window_id`) REFERENCES `ifc_building_storey_window` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ifc_building_storey_window_style` (
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWSTYLE_WINDOW` FOREIGN KEY (`window_id`) REFERENCES `ifc_building_storey_window` (`guid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-07-18 17:36:10
