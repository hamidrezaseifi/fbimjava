...
CREATE TABLE `ifc_building_properties` (
  ...
  KEY `IFCBUILDINGPROPERTIES_PROPERTY` (`property_id`),
  ...
  CONSTRAINT `IFCBUILDINGPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_beam_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYBEAMPLAYER_PLAYER` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYBEAMPLAYER_PLAYER` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_beam_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYBEAM_BEAM` (`beam_id`),
  KEY `IFCBUILDINGSTOREYBEAMPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYBEAMPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_covering_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYCOVERINGPLAYER_PLAYER` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYCOVERINGPLAYER_PLAYER` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_covering_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYCOVERING_COVERING` (`covering_id`),
  KEY `IFCBUILDINGSTOREYCOVERINGPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYCOVERINGPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_door_presentationlayer` (
  ...
  KEY `IFCBUILDINGSTOREYDOORPRESENTATION_PRESENTATION` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORPRESENTATION_PRESENTATION` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_door_properties` (
  ...
  KEY `IFCBUILDINGSTOREYDOORPROPERTIES_PROPERTY` (`property_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_door_style` (
  ...
  KEY `IFCBUILDINGSTOREYDOORSTYLE_STYLE` (`style_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYDOORSTYLE_PROPERTY` FOREIGN KEY (`style_id`) REFERENCES `ifc_doorstyle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_properties` (
  ...
  KEY `IFCBUILDINGSTOREYPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_slab_presentationlayer` (
  ...
  KEY `IFCBUILDINGSTOREYSLABPRESENTATION_PRESENTATION` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSLABPRESENTATION_PRESENTATION` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_slab_properties` (
  ...
  KEY `IFCBUILDINGSTOREYSLABPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSLABPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_space` (
  ...
  `updated` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSPACE_STOREY` (`stair_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSPACE_STOREY` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement` (
  ...
  `updated` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENT_STOREY` (`stair_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENT_STOREY` FOREIGN KEY (`stair_id`) REFERENCES `ifc_building_storey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_furnituretypes` (
  ...
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENTFURNITURETYPES_FURNITURETYPE` (`furnituretype_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTFURNITURETYPES_FURNITURETYPE` FOREIGN KEY (`furnituretype_id`) REFERENCES `ifc_furnituretypes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENTPLAYER_PLAYER` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTPLAYER_PLAYER` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_space_furnishingelement_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENT_FELEMENT` (`felement_id`),
  KEY `IFCBUILDINGSTOREYFURNISHINGELEMENTPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYFURNISHINGELEMENTPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_space_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSPACE_SPACE` (`space_id`),
  KEY `IFCBUILDINGSTOREYSPACEPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSPACEPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_stair_flight_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYSTAIRFLIGHTPLAYER_PLAYER` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHTPLAYER_PLAYER` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_flight_properties` (
  ...
  KEY `IFCBUILDINGSTOREYSTAIRFLIGHTPROPERTIES_PROPERTY` (`property_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRFLIGHTPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_member_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYSTAIRMEMBERPLAYER_PLAYER` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBERPLAYER_PLAYER` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_stair_member_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRMEMBER_MEMBER` (`member_id`),
  KEY `IFCBUILDINGSTOREYSTAIRMEMBERPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRMEMBERPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_stair_properties` (
  ...
  KEY `IFCBUILDINGSTOREYSTAIRPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_stair_railing_presentationlayers` (
  ...
  KEY `IFCBUILDINGSTOREYSTAIRRAILINGPLAYER_PLAYER` (`presentationlayer_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILINGPLAYER_PLAYER` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_stair_railing_properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `IFCBUILDINGSTOREYSTAIRRAILING_RAILING` (`railing_id`),
  KEY `IFCBUILDINGSTOREYSTAIRRAILINGPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYSTAIRRAILINGPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_wall_opening_presentationlayer` (
  ...
  KEY `IFCBUILDINGSTOREYWALLOPENINGPRESENTATION_PRESENTATION` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLOPENINGPRESENTATION_PRESENTATION` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_presentationlayer` (
  ...
  KEY `IFCBUILDINGSTOREYWALLPRESENTATION_PRESENTATION` (`presentationlayer_id`),
  ...
  CONSTRAINT `IFCBUILDINGSTOREYWALLPRESENTATION_PRESENTATION` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ifc_building_storey_wall_properties` (
  ...
  KEY `IFCBUILDINGSTOREYWALLPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYWALLPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_window_presentationlayer` (
  ...
  KEY `IFCBUILDINGSTOREYWINDOWPRESENTATION_PRESENTATION` (`presentationlayer_id`),
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWPRESENTATION_PRESENTATION` FOREIGN KEY (`presentationlayer_id`) REFERENCES `ifc_presentationlayers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_window_properties` (
  ...
  KEY `IFCBUILDINGSTOREYWINDOWPROPERTIES_PROPERTY` (`property_id`),
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWPROPERTIES_PROPERTY` FOREIGN KEY (`property_id`) REFERENCES `ifc_properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ifc_building_storey_window_style` (
  ...
  KEY `IFCBUILDINGSTOREYWINDOWSTYLE_STYLE` (`style_id`),
  CONSTRAINT `IFCBUILDINGSTOREYWINDOWSTYLE_PROPERTY` FOREIGN KEY (`style_id`) REFERENCES `ifc_windowstyle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `futurebim`.`ifc_properties_value_BEFORE_UPDATE` BEFORE UPDATE ON `ifc_properties_value` FOR EACH ROW
set new.updated = CURRENT_TIMESTAMP(6) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `futurebim`.`ifc_units_BEFORE_UPDATE` BEFORE UPDATE ON `ifc_units` FOR EACH ROW
set new.updated = CURRENT_TIMESTAMP(6) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-06-28 13:00:09
