...
CREATE TABLE `companies` (
  ...
  `identname` varchar(20) DEFAULT NULL,
...
INSERT INTO `companies` VALUES (1,'00011','Test Company',NULL,4,1,'2018-06-04 19:31:58.672344','2018-12-11 10:12:15.412205'),(2,'00012','Company 1',NULL,4,1,'2018-06-08 19:10:21.325301','2018-12-11 10:12:15.413205'),(3,'00013','Company 2',NULL,4,1,'2018-06-08 19:10:21.328295','2018-12-11 10:12:15.414205'),(4,'00014','Company 3',NULL,4,1,'2018-06-09 10:13:19.446634','2018-12-11 10:12:15.415205');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `featurebim`.`company_emails_BEFORE_UPDATE` BEFORE UPDATE ON `company_emails` FOR EACH ROW
BEGIN
set NEW.updated=CURRENT_TIMESTAMP(6);
END */;;
DELIMITER ;
...
CREATE TABLE `company_phonesnumbers` (
  ...
  `updated` timestamp(6) NOT NULL DEFAULT current_timestamp(6),
  PRIMARY KEY (`id`),
  KEY `FK_COMPANYPHONUMBER_COMPANY_idx` (`companyid`),
  CONSTRAINT `FK_COMPANYPHONUMBER_COMPANY` FOREIGN KEY (`companyid`) REFERENCES `companies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `featurebim`.`company_phonesnumbers_BEFORE_UPDATE` BEFORE UPDATE ON `company_phonesnumbers` FOR EACH ROW
BEGIN
set NEW.updated=CURRENT_TIMESTAMP(6);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `featurebim`.`company_postaladdresses_BEFORE_UPDATE` BEFORE UPDATE ON `company_postaladdresses` FOR EACH ROW
BEGIN
set NEW.updated=CURRENT_TIMESTAMP(6);
END */;;
DELIMITER ;
...
INSERT INTO `user_roles` VALUES (1,25,'2018-12-13 13:05:06.534271'),(2,5,'2018-11-28 15:19:16.222107'),(2,10,'2018-11-28 15:19:24.037107');
...
INSERT INTO `users` VALUES (1,1,'admin','$2a$10$2R.Yz0dOOAnfRH71zEzGLuq4/e39YnyxQfsJx2CxE5pxLEOwMO2ry',1,'Hamidreza','Seifi','n.t.','1977-09-11 00:00:00','hh@gg.com',1,2,'2018-06-04 07:51:54.890891','2018-12-13 13:05:06.681271'),(2,1,'user','$2a$10$JRkYyAEuswbwqUEVPpwioetQ.9UqBUuVleMaLEzCJk2BAeec8oMjm',0,'User','User',NULL,NULL,'',4,1,'2018-06-04 07:52:09.815891','2018-12-13 13:07:17.760271'),(3,1,'u2','u2',0,'Test','Test',NULL,NULL,'',4,1,'2018-06-04 07:52:09.815891','2018-12-13 13:07:17.761271');
...
-- Dump completed on 2018-12-13 14:18:34
