...
public class ProjectRestResponse extends FeatureBimUiRestResponse {
  ...
  public static ProjectRestResponse createError(final HttpStatus status, final Exception ex) {
    return (ProjectRestResponse) new FeatureBimUiRestResponse(status, ex.getClass().getName(), ex.getMessage());
  }
