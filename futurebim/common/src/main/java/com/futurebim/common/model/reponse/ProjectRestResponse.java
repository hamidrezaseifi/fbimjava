...
public class ProjectRestResponse extends FutureBimUiRestResponse {
  ...
  public static ProjectRestResponse createError(final HttpStatus status, final Exception ex) {
    return (ProjectRestResponse) new FutureBimUiRestResponse(status, ex.getClass().getName(), ex.getMessage());
  }
