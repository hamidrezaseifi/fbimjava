        ...
        var p = new Promise(function(resolve, reject){
	        var str = "import(\"http://localhost:3030/apps/bimserverjavascriptapi/bimserverclient.js?_v=" + apiVersion + "\").then((bimserverapi) => {	window.BimServerClient = bimserverapi.default; window.BimServerApiPromise = bimserverapi.BimServerApiPromise; resolve(bimserverapi);});";
			eval(str);
        });
        p.then(() => {
...
//params.api.getModel
    	                bimSurfer.load({
    	                    ...
    	                    //test: true,
    	                    //token: "B4F4661F1B329D594D556303E27536D4",
